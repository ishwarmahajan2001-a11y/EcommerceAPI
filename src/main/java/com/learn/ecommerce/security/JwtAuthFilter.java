 ...
 * is present, it loads the user and populates the SecurityContext so
 * downstream authorization checks (@PreAuthorize, URL rules) can run.
 *
 * OncePerRequestFilter guarantees a single execution per request.
 */
@Component
